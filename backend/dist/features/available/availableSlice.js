...
exports.fetchAvailable = exports.loadAvailable = exports.fetchAvailableSuccess = exports.availableSlice = void 0;
...
exports.fetchAvailableSuccess = exports.availableSlice.actions.fetchAvailableSuccess;
...
const saveAvailable = (available) => {
    fs_1.default.writeFileSync(availableFilename, JSON.stringify(available));
};
